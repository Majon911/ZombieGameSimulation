...
class plague_inc:
    def __init__(self, city_instance):
        ...
        self.prompts_high_concern = ["Desperate civians eat pizza in hopes to boost immunity","Experts warn of impending doom as cute and cuddly zombies begin attacking humans", f"Schools in {self.name} close down", "Widespread chaos", "Shops looted", "Widespread power outages", "FOX news advocates for reopening of schools"]
